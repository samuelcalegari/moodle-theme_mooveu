...
function theme_mooveu_get_main_scss_content($theme)
{
    global $CFG;
    ...
    // Mooveu scss
    $mooveu = file_get_contents($CFG->dirroot . '/theme/mooveu/scss/default.scss');
...
function theme_mooveu_get_extra_scss() {
    $theme = theme_config::load('moove');
    $content = '';
...
function theme_mooveu_get_pre_scss() {
    $theme = theme_config::load('moove');
    $scss = '';
    $configurable = [
...
function theme_mooveu_get_precompiled_css() {
    global $CFG;
